            ...
            <section className="min-h-screen flex flex-col items-center py-10 lg:py-20 px-5 space-y-10">
                ...
                <div className="relative max-w-5xl w-full mx-auto text-white">
                    ...
                    <div className="relative p-6">
                        ...
                        MediVerse, tıp öğrencileri ve sağlık alanındaki uzmanları yenilikçi bir platformda buluşturmayı hedefleyen bir bilgi paylaşım kongresidir. İlk kez Türkiye genelinde, sağlığın geleceğini şekillendiren teknolojik gelişmeler, yapay zeka, nadir hastalıklar, 3D organ nakilleri ve Alzheimer gibi konuları ele alan multidisipliner bir yaklaşımla tasarlanmıştır. MediVerse, alanında lider uzmanları ve hevesli tıp öğrencilerini bir araya getirerek hem öğrenme hem de ilham dolu bir ortam sunmayı amaçlamaktadır.
                            <br /><br />
